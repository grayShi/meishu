        ...
        <div class="table-top" style="max-height: 720px;">
            ...
            <div class="table-div">
                ...
                <table title=第${status.count}张 cellSpacing=1 cellPadding=0 width=410px align=center>
                    <tbody>
                        <c:if test="${title == ''}">
                            <tr> <td style="line-height: 20px;height:88px;text-align:center"  colSpan=3 ><span style="font-size: 20px; font-weight: 600">全国语言等级考试准考证</span></br>
                        ...
                        <table title=第${status.count}张 cellSpacing=1 cellPadding=0 style="width:318px; height:410px;margin-left: 49px;margin-top: -36px;border: 0" class="table-height">
                            <tbody>
                            <tr> <td style="line-height: 20px" height=60px colSpan=2 align=center><span style="font-size: 20px; font-weight: 600">考生守则</span></td></tr>
                            <tr><td class="message-table" colSpan=2>一、<span>考生须在考级前30分钟到达考场。</span></td></tr>
                            <tr><td class="message-table" colSpan=1>二、<span>考生需准备好本人准考证和身份证或其它有效证件，如信息与报名信息不符，不得进入考场参加考试。</span></td>
                                <td style="padding-right: 6px; font-size: 12px;" rowSpan=4 width=121 align=center>
                                    <table  class="photo-table" cellSpacing=0 cellPadding=0 width=150 align=center>
                                        <tbody> <tr> <td width=150 align=center> <div style="width: 100%; font-size: 12px">二寸照片一张</br>(写上姓名及考号)</div></td></tr></tbody></table>
                                    (用于证书制作)
                                </td></tr>
                            <tr> <td class="message-table" colSpan=1>三、<span>考生进入备考室后，按照考级顺序抽取考题,1-5级考题的准备时间为10分钟,6-10级的考题准备时间为15分钟。考生抽取考题后不得更换。</span></td></tr>
                            <tr> <td class="message-table" colSpan=1>四、<span>考生进入备考室考场只允许携带规定的考级用具，不得携带手机或与考级相关的物品。</span></td></tr>
