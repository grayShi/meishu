...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">新增考试持续时间</h1>
            </div>
            <div class="col-lg-12">
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <table class="table vertical-table vertical-table1">
                    ...
                    <tr>
                        <td>科目名称</td>
                        <td><select id="subject" class="form-control" onchange="javascript:setLevel()">
                    ...
                    <tr>
                        <td>持续时间(分钟)</td>
                        <td><input id="duration" class="form-control" /></td>
                    </tr>
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-5 col-md-4 col-md-offset-5 col-sm-4 col-sm-offset-4">
                <button class="btn btn-default" data-toggle="modal"  onclick="addExamTime()">提交</button>
            </div>
        </div>
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data=="success")
                        ...
                        $("#message").html("科目："+subject+level+"级 考试持续时间已存在");
                        $('#false').modal('show');
                    }else{
