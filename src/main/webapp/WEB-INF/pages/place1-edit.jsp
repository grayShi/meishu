...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">修改考点地址</h1>
            </div>
            <div class="col-lg-12">
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <table class="table vertical-table vertical-table1" id="table">
                    ...
                    <c:forEach items="${placeEdit}" var="item">
                        <tr>
                            <td>考点地址</td>
                            <td><input class="form-control" id="place" value="${item.place}"/></td>
                        </tr>
                        <tr>
                            <td>考场地址</td>
                            <td><input class="form-control" id="classPlace" value="${item.classPlace}"/></td>
                        </tr>
                        <tr>
                            <td>容纳人数</td>
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data=="success")
                        ...
                        $("#message").html("已分配考试人数("+data+"人)超过考场容纳人数");
                        $('#false').modal('show');
                    }
                }
            })
