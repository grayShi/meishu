...
public class cost1Controller extends BaseController{
    ...
    public ModelAndView home(ModelAndView modelAndView) {
        ...
        List<message> reportPlaceList = messageDao.findAll("select distinct reportPlace from message where isDelete = 0");
    ...
    @ResponseBody
    public String getLevel(@RequestParam(value="level") String level,@RequestParam(value="examTime") String examTime,
                           @RequestParam(value="reportPlace")String reportPlace, @RequestParam(value="subPlace")String subPlace){
        String sql1="";
        String sql2="";
        String sql3="";
        String sql4="";
        String sql = "select reportPlace,subPlace,level,count(*),time from message as message where isDelete = 0 ";
        if(!level.equals("0") || !reportPlace.equals("0") || !subPlace.equals("0") || !examTime.equals("0"))
            sql+="and ";
        if(!level.equals("0")){
            sql1 += "level = " + level;
        }
        ...
        sql+=sql1+sql2+sql3+sql4+" group by reportPlace,subPlace,level,message.time";
