...
public class MessageController extends BaseController{
    ...
    @ResponseBody
    public String getSubPlace(@RequestParam(value = "place") String place){
    ...
    public String saveMessage(@RequestParam(value = "reportPlace") String reportPlace, @RequestParam(value = "subPlace") String subPlace,
        ...
        if(level<10)
            Id+='0';
        Id+=level;
        Long countId=messageDao.getCount("select count (*) from message where reportPlace = '"+Message.getReportPlace()+"'and subPlace = '"+Message.getSubPlace()+"' and subject='"+subject+"'and level = "+level)+1;
        if(countId<1000)
            Id+='0';
        if(countId<100)
            Id+='0';
...
//    }
    ...
    public String editMessage(@RequestParam(value = "id")Long id,@RequestParam(value = "reportPlace") String reportPlace, @RequestParam(value = "subPlace") String subPlace,
        ...
        Message.setIsDelete(0);
        Date date = new Date();
        String Id=(date.getYear()+1900+"").substring(2);             /////////////////准考证前两位  当前录入年份
        String placeId=""+placeDao.setId(reportPlace);
        String subPlaceId="";
